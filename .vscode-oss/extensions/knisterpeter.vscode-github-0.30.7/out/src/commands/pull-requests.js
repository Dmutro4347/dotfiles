...
exports.UpdatePullRequest = exports.MergePullRequest = exports.CreatePullRequest = exports.CreateSimplePullRequest = exports.CreatePullRequestWithParameters = exports.CheckoutPullRequest = exports.BrowseSimpleRequest = exports.BrowsePullRequest = void 0;
...
let CreatePullRequest = class CreatePullRequest extends PullRequestCommand {
    ...
    getTargetBranch(defaultBranch, uri) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const currentBranch = yield this.git.getCurrentBranch(uri);
    ...
    runWithToken() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (pullRequest && pullRequest.mergeable) {
                ...
                vscode.window.showWarningMessage('Either no pull request for current branch, or the pull request is not mergable');
            }
        });
    }
};
